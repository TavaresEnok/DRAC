...
export const styles = StyleSheet.create({
  ...
  cameraCard: { height: 204, borderRadius: 28, overflow: 'hidden', backgroundColor: '#0f172a', borderWidth: 1, borderColor: 'rgba(30,41,59,0.86)', shadowColor: '#000', shadowOpacity: 0.38, shadowRadius: 18, elevation: 6 },
  cameraPreview: { position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, backgroundColor: '#1e293b', overflow: 'hidden', alignItems: 'center', justifyContent: 'center' },
  ...
  cardPlayButton: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#34d399', alignItems: 'center', justifyContent: 'center', shadowColor: '#34d399', shadowOpacity: 0.34, shadowRadius: 14, elevation: 8 },
  ...
  mosaicSubtitle: { color: '#94a3b8', fontSize: 13, fontWeight: '700', marginTop: 3 },
  ...
  areaCreatorCard: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#0f172a', borderWidth: 1, borderColor: '#1e293b', borderRadius: 22, padding: 10 },
  areaCreatorInput: { flex: 1, minHeight: 44, color: '#f8fafc', fontSize: 13, fontWeight: '700', paddingHorizontal: 10 },
  areaCreatorButton: { height: 44, borderRadius: 16, paddingHorizontal: 14, backgroundColor: '#34d399', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  areaCreatorButtonText: { color: '#02130f', fontSize: 12, fontWeight: '900' },
  ...
  groupFilterChipActiveSoft: { backgroundColor: 'rgba(52,211,153,0.10)', borderColor: 'rgba(52,211,153,0.28)' },
  groupFilterText: { color: '#94a3b8', fontSize: 12, fontWeight: '900' },
  groupFilterTextActive: { color: '#02130f' },
  groupFilterTextActiveSoft: { color: '#a7f3d0' },
  areaEditorCard: { backgroundColor: '#0f172a', borderWidth: 1, borderColor: 'rgba(52,211,153,0.24)', borderRadius: 24, padding: 14, gap: 14 },
  areaEditorHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 12 },
  areaEditorTitle: { color: '#f8fafc', fontSize: 16, fontWeight: '900' },
  areaEditorSubtitle: { color: '#94a3b8', fontSize: 12, fontWeight: '700', marginTop: 2 },
  ...
  cameraPickerChip: { borderWidth: 1, borderColor: '#1e293b', backgroundColor: '#020617', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 },
  cameraPickerChipActive: { backgroundColor: 'rgba(52,211,153,0.14)', borderColor: 'rgba(52,211,153,0.34)' },
  cameraPickerText: { color: '#94a3b8', fontSize: 11, fontWeight: '900' },
  cameraPickerTextActive: { color: '#a7f3d0' },
  ...
  playbackPlayerCard: { borderWidth: 1, borderColor: 'rgba(52,211,153,0.22)', backgroundColor: '#0f172a', borderRadius: 32, padding: 13, gap: 13, shadowColor: '#000', shadowOpacity: 0.42, shadowRadius: 22, elevation: 7 },
  playbackHeader: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 },
  playbackTitle: { color: '#f8fafc', fontSize: 18, fontWeight: '900', letterSpacing: -0.2 },
  ...
  cloudReplayBadge: { color: '#d1fae5', fontSize: 10, fontWeight: '900', letterSpacing: 1.1, backgroundColor: 'rgba(2,6,23,0.72)', borderWidth: 1, borderColor: 'rgba(52,211,153,0.28)', borderRadius: 999, overflow: 'hidden', paddingHorizontal: 10, paddingVertical: 6 },
