...
export const styles = StyleSheet.create({
  ...
  // ── Alarmes ───────────────────────────────────────────────
  alarmCountPill:        { minWidth: 36, height: 28, borderRadius: 14, paddingHorizontal: 10, backgroundColor: C.surfaceAlt, borderWidth: 1, borderColor: C.border, alignItems: 'center', justifyContent: 'center' },
  alarmCountPillActive:  { backgroundColor: C.dangerBg, borderColor: C.dangerBorder },
  alarmCountText:        { color: C.textSub, fontSize: 13, fontWeight: '900' },
  alarmCountTextActive:  { color: C.dangerText },
  alarmCard:             { flexDirection: 'row', backgroundColor: C.surface, borderRadius: 16, borderWidth: 1, borderColor: C.border, overflow: 'hidden', marginBottom: 10 },
  alarmCardResolved:     { opacity: 0.6 },
  alarmPriorityBar:      { width: 5 },
  alarmBody:             { flex: 1, padding: 13, gap: 8 },
  alarmTopRow:           { flexDirection: 'row', alignItems: 'center', gap: 7, flexWrap: 'wrap' },
  alarmPriorityTag:      { borderRadius: 6, paddingHorizontal: 7, paddingVertical: 2 },
  alarmPriorityTagText:  { color: '#ffffff', fontSize: 10, fontWeight: '900', letterSpacing: 0.5 },
  alarmType:             { flex: 1, color: C.text, fontSize: 14, fontWeight: '800' },
  alarmAckedBadge:       { color: C.accentText, fontSize: 9, fontWeight: '900', letterSpacing: 0.5, backgroundColor: C.accentBg, borderRadius: 5, paddingHorizontal: 6, paddingVertical: 2 },
  alarmSnoozedBadge:     { color: C.textSub, fontSize: 9, fontWeight: '900', letterSpacing: 0.5, backgroundColor: C.surfaceAlt, borderRadius: 5, paddingHorizontal: 6, paddingVertical: 2 },
  alarmMessage:          { color: C.textSub, fontSize: 13, lineHeight: 18 },
  alarmMetaRow:          { flexDirection: 'row', alignItems: 'center', gap: 5 },
  alarmMetaText:         { color: C.textMuted, fontSize: 11, fontWeight: '600' },
  alarmMetaDot:          { color: C.textMuted, fontSize: 11 },
  alarmActionsRow:       { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 2, flexWrap: 'wrap' },
  alarmActionButton:     { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, height: 38, borderRadius: 11, paddingHorizontal: 14 },
  alarmActionGhost:      { backgroundColor: C.accentBg, borderWidth: 1, borderColor: C.borderFocus },
  alarmActionGhostText:  { color: C.accentText, fontSize: 12, fontWeight: '800' },
  alarmActionAck:        { backgroundColor: C.surfaceAlt, borderWidth: 1, borderColor: C.border },
  alarmActionAckText:    { color: C.text, fontSize: 12, fontWeight: '800' },
  alarmActionResolve:    { backgroundColor: C.accent },
  alarmActionResolveText:{ color: C.textOnAccent, fontSize: 12, fontWeight: '800' },
});
