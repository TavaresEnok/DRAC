      ...
      <ScrollView refreshControl={<RefreshControl refreshing={refreshing} onRefresh={loadAll} />} contentContainerStyle={styles.content}>
        {tab === 'dashboard' && (
          <View style={styles.page}>
            <LinearGradient colors={['#FFFFFF', '#E7F0EA']} style={styles.heroCard}>
              <View>
...
const styles = StyleSheet.create({
  ...
  loginHero: { gap: 10 },
  logoMark: { width: 76, height: 76, borderRadius: 28, backgroundColor: '#163A35', alignItems: 'center', justifyContent: 'center', shadowColor: '#0E7C66', shadowOpacity: 0.28, shadowRadius: 24, elevation: 10, borderWidth: 1, borderColor: '#C8D7CF' },
  logoLens: { width: 34, height: 34, borderRadius: 17, borderWidth: 8, borderColor: '#13A17F', backgroundColor: '#F4F1EA' },
  loginBrand: { color: '#0E7C66', fontSize: 16, fontWeight: '900', letterSpacing: 3, textTransform: 'uppercase', marginTop: 8 },
  loginTitle: { color: '#15211E', fontSize: 36, lineHeight: 40, fontWeight: '900', maxWidth: 330 },
  loginSubtitle: { color: '#64716C', fontSize: 15, lineHeight: 22, maxWidth: 350 },
  loginCard: { backgroundColor: 'rgba(255,255,255,0.94)', borderWidth: 1, borderColor: 'rgba(14,124,102,0.16)', borderRadius: 30, padding: 18, gap: 8, shadowColor: '#000', shadowOpacity: 0.36, shadowRadius: 28, elevation: 12 },
  formLabel: { color: '#7c938b', fontSize: 11, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1.2, marginLeft: 2, marginTop: 4 },
  input: { height: 52, borderWidth: 1, borderColor: '#D9E2DD', backgroundColor: '#FFFFFF', borderRadius: 18, paddingHorizontal: 14, color: '#15211E', fontSize: 14 },
  primaryButton: { height: 54, borderRadius: 19, alignItems: 'center', justifyContent: 'center', backgroundColor: '#0E7C66', marginTop: 10, shadowColor: '#0E7C66', shadowOpacity: 0.26, shadowRadius: 18, elevation: 7 },
  primaryButtonText: { color: '#FFFFFF', fontWeight: '900', fontSize: 14 },

  topBar: { paddingHorizontal: 18, paddingTop: 12, paddingBottom: 14, borderBottomWidth: 1, borderColor: '#E2E8E3', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#F4F1EA' },
  appName: { color: '#14201D', fontSize: 25, fontWeight: '900', letterSpacing: 0.2 },
  headerMeta: { color: '#66736E', fontSize: 12, marginTop: 2 },
  refreshButton: { borderWidth: 1, borderColor: '#D5DFDA', backgroundColor: '#FFFFFF', borderRadius: 999, paddingHorizontal: 14, paddingVertical: 9 },
  refreshText: { color: '#0E7C66', fontSize: 12, fontWeight: '900' },
  content: { padding: 16, paddingBottom: 142, backgroundColor: '#F4F1EA' },
  page: { gap: 16 },

  heroCard: { borderRadius: 32, padding: 22, minHeight: 158, justifyContent: 'space-between', overflow: 'hidden', borderWidth: 1, borderColor: '#C9D8D0' },
  heroEyebrow: { color: '#0E7C66', fontSize: 11, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1.5 },
  heroTitle: { color: '#15211E', fontSize: 29, fontWeight: '900', marginTop: 8 },
  heroSubtitle: { color: '#68756F', fontSize: 13, marginTop: 6, lineHeight: 19, maxWidth: 290 },
  heroDot: { position: 'absolute', right: -36, bottom: -42, width: 160, height: 160, borderRadius: 80, backgroundColor: 'rgba(14,124,102,0.12)' },
  metricsRow: { flexDirection: 'row', gap: 10 },
  metric: { flex: 1, borderWidth: 1, borderColor: '#DDE7E2', backgroundColor: '#FFFFFF', borderRadius: 24, padding: 15, shadowColor: '#000', shadowOpacity: 0.18, shadowRadius: 12, elevation: 2 },
  metricValue: { color: '#15211E', fontSize: 24, fontWeight: '900' },
  metricLabel: { color: '#68756F', fontSize: 11, fontWeight: '800', marginTop: 2 },

  groupBlock: { gap: 12, marginTop: 4 },
  groupHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  groupTitle: { color: '#15211E', fontSize: 14, fontWeight: '900' },
  groupCount: { color: '#68756F', fontSize: 12, fontWeight: '800' },
  cameraCard: { borderWidth: 1, borderColor: '#DDE7E2', backgroundColor: '#FFFFFF', borderRadius: 28, padding: 10, flexDirection: 'row', gap: 13, shadowColor: '#000', shadowOpacity: 0.22, shadowRadius: 18, elevation: 4 },
  cameraPreview: { width: 112, minHeight: 96, borderRadius: 22, backgroundColor: '#111816', overflow: 'hidden', alignItems: 'center', justifyContent: 'center', position: 'relative' },
  cameraPreviewImage: { position: 'absolute', width: '100%', height: '100%', resizeMode: 'cover' },
  cameraPreviewFallback: { position: 'absolute', width: '100%', height: '100%', backgroundColor: '#E2E8E3', alignItems: 'center', justifyContent: 'center' },
  cameraPreviewShade: { position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.18)' },
  cameraPreviewText: { color: '#13A17F', fontSize: 11, fontWeight: '900', letterSpacing: 1.8 },
  ...
  cameraName: { color: '#15211E', fontWeight: '900', fontSize: 16, flexShrink: 1 },
  cameraMeta: { color: '#68756F', fontSize: 12, marginTop: 2 },
  statusPill: { borderRadius: 999, paddingHorizontal: 8, paddingVertical: 4, borderWidth: 1 },
  statusOnline: { backgroundColor: 'rgba(14,124,102,0.10)', borderColor: 'rgba(14,124,102,0.28)' },
  statusOffline: { backgroundColor: 'rgba(255,91,91,0.12)', borderColor: 'rgba(255,91,91,0.28)' },
  statusText: { fontSize: 9, fontWeight: '900' },
  statusTextOnline: { color: '#0E7C66' },
  statusTextOffline: { color: '#ff9d9d' },
  permissionRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 6 },
  permissionBadge: { color: '#4E625B', backgroundColor: '#EEF5F1', borderRadius: 999, overflow: 'hidden', paddingHorizontal: 8, paddingVertical: 3, fontSize: 10, fontWeight: '900' },

  sectionHeader: { gap: 10 },
  sectionTitle: { color: '#15211E', fontSize: 25, fontWeight: '900' },
  sectionSubtitle: { color: '#68756F', fontSize: 13, marginTop: 2 },
  segmented: { flexDirection: 'row', gap: 8 },
  chip: { borderWidth: 1, borderColor: '#D5DFDA', backgroundColor: '#FFFFFF', borderRadius: 999, paddingHorizontal: 14, paddingVertical: 9 },
  chipActive: { backgroundColor: '#0E7C66', borderColor: '#0E7C66' },
  chipText: { color: '#5F6F69', fontWeight: '900', fontSize: 12 },
  chipTextActive: { color: '#FFFFFF' },

  grid: { gap: 12 },
  gridTile: { borderWidth: 1, borderColor: '#DDE7E2', backgroundColor: '#FFFFFF', borderRadius: 26, overflow: 'hidden' },
  gridTileActive: { borderColor: '#0E7C66', borderWidth: 2 },
  videoFrame: { position: 'relative', backgroundColor: '#111816', overflow: 'hidden' },
  videoPoster: { position: 'absolute', width: '100%', aspectRatio: 16 / 9, resizeMode: 'cover', opacity: 0.72 },
  video: { width: '100%', aspectRatio: 16 / 9, backgroundColor: '#111816' },
  videoEmpty: { alignItems: 'center', justifyContent: 'center', padding: 18 },
  videoEmptyTitle: { color: '#14201D', fontSize: 14, fontWeight: '900' },
  videoEmptyText: { color: '#66736E', fontSize: 12, marginTop: 4, textAlign: 'center' },
  videoOverlayTop: { position: 'absolute', top: 10, left: 10, right: 10, flexDirection: 'row', justifyContent: 'space-between' },
  videoOverlayTitle: { color: '#FFFFFF', fontSize: 12, fontWeight: '900', backgroundColor: 'rgba(0,0,0,0.55)', borderRadius: 999, overflow: 'hidden', paddingHorizontal: 10, paddingVertical: 5 },
  videoProtocol: { color: '#FFFFFF', fontSize: 10, fontWeight: '900', backgroundColor: '#0E7C66', borderRadius: 999, overflow: 'hidden', paddingHorizontal: 10, paddingVertical: 5 },
  tileFooter: { padding: 12 },
  tileTitle: { color: '#15211E', fontWeight: '900', fontSize: 13 },
  tileMeta: { color: '#68756F', fontSize: 11, marginTop: 2 },

  controlCard: { borderWidth: 1, borderColor: '#DDE7E2', backgroundColor: '#FFFFFF', borderRadius: 30, padding: 15, gap: 15, shadowColor: '#000', shadowOpacity: 0.24, shadowRadius: 18, elevation: 3 },
  controlHeader: { flexDirection: 'row', justifyContent: 'space-between', gap: 10, alignItems: 'flex-start' },
  panelTitle: { color: '#15211E', fontWeight: '900', fontSize: 18 },
  actionGrid: { flexDirection: 'row', gap: 8 },
  actionPill: { flex: 1, borderWidth: 1, borderRadius: 17, alignItems: 'center', justifyContent: 'center', paddingVertical: 13 },
  actionPill_neutral: { borderColor: '#D3DDD8', backgroundColor: '#F8FAF7' },
  actionPill_danger: { borderColor: 'rgba(255,91,91,0.34)', backgroundColor: 'rgba(255,91,91,0.12)' },
  actionPill_success: { borderColor: 'rgba(14,124,102,0.30)', backgroundColor: 'rgba(14,124,102,0.10)' },
  actionPillText: { fontWeight: '900', fontSize: 12 },
  actionPillText_neutral: { color: '#15211E' },
  actionPillText_danger: { color: '#ff9d9d' },
  actionPillText_success: { color: '#0E7C66' },
  disabled: { opacity: 0.36 },
  ptzCard: { backgroundColor: '#FFFFFF', borderRadius: 26, padding: 15, gap: 14, borderWidth: 1, borderColor: '#DDE7E2' },
  ptzHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  ptzTitle: { color: '#15211E', fontWeight: '900', fontSize: 14 },
  ptzSubtitle: { color: '#68756F', fontSize: 12, fontWeight: '800' },
  ptzPad: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  ptzButton: { width: '30%', minHeight: 56, borderWidth: 1, borderColor: '#D5DFDA', borderRadius: 19, backgroundColor: '#F8FAF7', alignItems: 'center', justifyContent: 'center' },
  ptzCenter: { width: '30%', minHeight: 56, borderRadius: 19, backgroundColor: '#0E7C66', alignItems: 'center', justifyContent: 'center' },
  ptzText: { color: '#15211E', fontWeight: '900', fontSize: 11 },
  ptzCenterText: { color: '#FFFFFF', fontWeight: '900', fontSize: 12 },
  ...
  singleVideoCard: { borderWidth: 1, borderColor: '#DDE7E2', backgroundColor: '#111816', borderRadius: 30, overflow: 'hidden', shadowColor: '#000', shadowOpacity: 0.35, shadowRadius: 26, elevation: 8 },
  ...
  liveNowText: { color: '#FFFFFF', fontSize: 11, fontWeight: '900', letterSpacing: 1, backgroundColor: 'rgba(0,0,0,0.62)', borderRadius: 999, overflow: 'hidden', paddingHorizontal: 11, paddingVertical: 6 },
  actionDock: { flexDirection: 'row', gap: 9, borderWidth: 1, borderColor: '#DDE7E2', backgroundColor: '#FFFFFF', borderRadius: 24, padding: 9 },
  ptzCardPremium: { backgroundColor: '#FFFFFF', borderRadius: 30, padding: 16, gap: 16, borderWidth: 1, borderColor: '#DDE7E2', shadowColor: '#000', shadowOpacity: 0.24, shadowRadius: 20, elevation: 5 },
  ptzFeedback: { color: '#FFFFFF', backgroundColor: '#0E7C66', overflow: 'hidden', borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6, fontSize: 10, fontWeight: '900' },
  ptzConsole: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 18 },
  ptzDpad: { width: 210, height: 210, borderRadius: 105, backgroundColor: '#EDF3EF', borderWidth: 1, borderColor: '#DDE7E2', position: 'relative', alignItems: 'center', justifyContent: 'center', shadowColor: '#000', shadowOpacity: 0.28, shadowRadius: 18, elevation: 5 },
  ptzRoundButton: { position: 'absolute', width: 66, height: 66, borderRadius: 28, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#D6E1DC', alignItems: 'center', justifyContent: 'center', shadowColor: '#000', shadowOpacity: 0.22, shadowRadius: 12, elevation: 4 },
  ptzRoundButtonActive: { backgroundColor: '#0E7C66', borderColor: '#0E7C66', transform: [{ scale: 0.92 }], shadowColor: '#0E7C66', shadowOpacity: 0.35, shadowRadius: 20 },
  ptzRoundText: { color: '#15211E', fontSize: 24, fontWeight: '900' },
  ptzRoundTextActive: { color: '#FFFFFF' },
  ptzUp: { top: 10, left: 72 },
  ptzLeft: { left: 10, top: 72 },
  ptzRight: { right: 10, top: 72 },
  ptzDown: { bottom: 10, left: 72 },
  ptzNub: { width: 72, height: 72, borderRadius: 36, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#D6E1DC', alignItems: 'center', justifyContent: 'center' },
  ptzNubText: { color: '#64716C', fontSize: 10, fontWeight: '900', letterSpacing: 1 },
  zoomColumn: { gap: 12 },
  ...
  gridTilePro: { borderWidth: 1, borderColor: '#DDE7E2', backgroundColor: '#FFFFFF', borderRadius: 24, overflow: 'hidden', width: '100%', shadowColor: '#000', shadowOpacity: 0.18, shadowRadius: 14, elevation: 3 },
  ...
  recordingTitle: { color: '#15211E', fontWeight: '900', fontSize: 15 },
  rowButtons: { flexDirection: 'row', gap: 8 },
  smallButton: { borderRadius: 15, backgroundColor: '#0E7C66', paddingHorizontal: 14, paddingVertical: 10 },
  smallButtonText: { color: '#FFFFFF', fontWeight: '900', fontSize: 12 },
  smallButtonDark: { borderRadius: 15, backgroundColor: '#F8FAF7', borderWidth: 1, borderColor: '#D5DFDA', paddingHorizontal: 14, paddingVertical: 10 },
  smallButtonDarkText: { color: '#15211E', fontWeight: '900', fontSize: 12 },
  emptyCard: { borderWidth: 1, borderColor: '#DDE7E2', backgroundColor: '#FFFFFF', borderRadius: 26, padding: 24, alignItems: 'center' },
  emptyTitle: { color: '#15211E', fontSize: 16, fontWeight: '900' },
  emptyText: { color: '#68756F', textAlign: 'center', marginTop: 6, lineHeight: 18 },

  profileCard: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DDE7E2', borderRadius: 30, padding: 22, alignItems: 'center', gap: 11 },
  avatar: { width: 72, height: 72, borderRadius: 36, backgroundColor: '#0E7C66', alignItems: 'center', justifyContent: 'center', shadowColor: '#0E7C66', shadowOpacity: 0.25, shadowRadius: 14, elevation: 5 },
  avatarText: { color: '#FFFFFF', fontSize: 28, fontWeight: '900' },
  profileName: { color: '#15211E', fontSize: 22, fontWeight: '900', marginTop: 4 },
  profileMeta: { color: '#68756F', fontSize: 13 },
  profileInfo: { width: '100%', borderWidth: 1, borderColor: '#DDE7E2', borderRadius: 19, padding: 13, marginTop: 4, backgroundColor: '#FFFFFF' },
  infoLabel: { color: '#66736E', fontSize: 11, fontWeight: '900', textTransform: 'uppercase' },
  infoValue: { color: '#15211E', fontSize: 13, fontWeight: '800', marginTop: 4 },
  ...
  tabs: { position: 'absolute', left: 12, right: 12, bottom: 28, backgroundColor: 'rgba(255,255,255,0.98)', borderWidth: 1, borderColor: '#DDE7E2', borderRadius: 28, padding: 6, flexDirection: 'row', gap: 4, shadowColor: '#000', shadowOpacity: 0.42, shadowRadius: 24, elevation: 20 },
  tab: { flex: 1, alignItems: 'center', borderRadius: 20, paddingVertical: 11 },
  tabActive: { backgroundColor: '#0E7C66' },
  tabText: { color: '#66736E', fontSize: 11, fontWeight: '900' },
