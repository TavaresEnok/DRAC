    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-border shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h1 className="text-[18px] font-semibold tracking-tight">Logs de Auditoria</h1>
            <p className="text-[11px] text-muted-foreground mt-0.5">Trilha de auditoria de ações no sistema</p>
          </div>
        </div>
