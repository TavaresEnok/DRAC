export const envConfig = () => ({
  ...
  mediaMtxRtspInternalUrl: process.env.MEDIAMTX_RTSP_INTERNAL_URL ?? 'rtsp://mediamtx:8554',
  ...
  mediaMtxPublicWebrtcUrl: process.env.MEDIAMTX_PUBLIC_WEBRTC_URL ?? '',
  mediaMtxPublicHlsUrl: process.env.MEDIAMTX_PUBLIC_HLS_URL ?? '',
