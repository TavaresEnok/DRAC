...
const RECORDING_MODE_COPY: Record<RecordingMode, { label: string; detail: string; className: string }> = {
  ...
  motion: {
    ...
    className: 'border-[hsl(38_58%_54%_/_0.35)] bg-[hsl(38_58%_54%_/_0.12)] text-[hsl(38_58%_58%)]',
  },
  continuous: {
    label: 'Contínua',
  ...
  schedule: {
    ...
    className: 'border-[hsl(var(--chart-2)_/_0.35)] bg-[hsl(var(--chart-2)_/_0.12)] text-[hsl(var(--chart-2))]',
  },
};
        ...
        <div className="p-5 min-h-48">
          {step === 0 && (
            <div className="space-y-3">
                  ...
                  <div className="mt-2 space-y-1.5">
                    {probeSteps.map((item) => (
                      <div key={item.key} className="flex items-start justify-between gap-3">
                        <span className={item.status === 'error' ? 'text-[hsl(var(--destructive))]' : item.status === 'warning' ? 'text-[hsl(38_58%_58%)]' : 'text-[hsl(152_46%_55%)]'}>
                          {item.label}
                        </span>
              ...
              {detectedMax && (
                <div className="rounded border border-[hsl(152_46%_44%_/_0.25)] bg-[hsl(152_46%_44%_/_0.1)] px-3 py-2 text-[11px] text-[hsl(152_46%_55%)]">
                  ...
                  <button
                    ...
                    className={`w-full h-9 rounded border text-xs flex items-center justify-center hover:bg-[hsl(var(--accent))] transition-colors disabled:opacity-45 ${
                      recordingActive
                        ...
                        : 'border-[hsl(152_46%_44%_/_0.55)] text-[hsl(152_46%_50%)]'
                    }`}
                  ...
                  <button
                    ...
                    className={`w-full h-9 rounded border text-xs flex items-center justify-center gap-1.5 transition-colors disabled:opacity-45 ${
                      motionActive
                        ...
                        : 'border-[hsl(152_46%_44%_/_0.55)] bg-[hsl(152_46%_44%_/_0.1)] text-[hsl(152_46%_50%)] hover:bg-[hsl(152_46%_44%_/_0.15)]'
                    }`}
