...
const PERMISSIONS = [
  { key: 'liveView',       label: 'Live View',          desc: 'Access live camera feeds' },
  { key: 'playback',       label: 'Playback',           desc: 'Review recorded footage' },
  ...
  { key: 'auditLogs',      label: 'Audit Logs',         desc: 'Access system audit trail' },
  ...
  { key: 'reportGenerate', label: 'Reports',            desc: 'Generate and export reports' },
];
        ...
        <SheetContent className="bg-card border-border w-80">
          ...
          <div className="mt-4 space-y-2">
            ...
            <div className="flex justify-end gap-2 pt-4">
              <button onClick={() => setEditRole(null)} className="h-8 px-4 rounded border border-border text-xs hover:bg-accent">Cancel</button>
              <button onClick={saveEdit} className="h-8 px-4 rounded bg-primary text-primary-foreground text-xs hover:bg-primary/90">Save</button>
            </div>
          </div>
        </SheetContent>
      </Sheet>
